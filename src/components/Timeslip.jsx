...
const Timeslip = ({
  ...
  <div className="timeslip">
    ...
    <div className="timeslip-hours">
      {' '}
      <Comment text={comment} onSetCommnet={onSetCommnet} />{' '}
      {parseInt(hours || 0, 10)}h
    </div>
  </div>
)
...
const Comment = ({ text, onSetCommnet }) => {
  ...
  return (
    <div className="glyphicon" onClick={setComment}>
      <CommentIcon text={text} />
    </div>
  )
}
...
const CommentIcon = ({ text }) => {
  ...
  if (strText.startsWith('wfh')) {
    return (
      <div className="timeslip-edit glyphicon glyphicon-home" title={text} />
    )
  } else if (strText.startsWith('holiday')) {
    return (
      <div className="timeslip-edit glyphicon glyphicon-plane" title={text} />
    )
