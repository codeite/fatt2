...
export default function Day(props) {
  ...
  if (props.loaded) {
    ...
    timeslipsHtml = timeslips.map(timeslip => {
      const taskNameOb = stores.taskDisplayNameStore.getTaskDisplayNameOb(
        timeslip.task
      )
      return (
        <Timeslip
          ...
          onDelete={e => {
            e.stopPropagation()
            props.onDeleteTimeslip(timeslip)
          }}
        />
      )
    })
  ...
  return (
    <div className={className} onClick={props.onSelectDay}>
      ...
      <div className="day-total">
        Total:{' '}
        <span className="day-total-hours">{parseInt(total || 0, 10)}h</span>
      </div>
